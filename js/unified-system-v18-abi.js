/**
 * DreamleUnifiedSystemV18_Optimized ABI
 * 自动生成于: 2025-09-29T23:27:41.232Z
 * BSC Mainnet 部署
 */

// DreamleUnifiedSystemV18_Optimized ABI
window.UNIFIED_SYSTEM_V18_ABI = [
  {
    "inputs": [
      {
...
// 兼容性：同时导出为 V16 名称以兼容旧代码
window.UNIFIED_SYSTEM_V16_ABI = window.UNIFIED_SYSTEM_V18_ABI;

console.log('✅ DreamleUnifiedSystemV18_Optimized ABI loaded (also available as V16_ABI for compatibility)');
